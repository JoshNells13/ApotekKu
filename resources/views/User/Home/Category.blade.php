        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                ...
                @if ($CategoryAll->isNotEmpty() )
                    ...
                    <a href="{{ route('category.show',$item->slug) }}" class="bg-white rounded-lg shadow hover:shadow-lg transition cursor-pointer p-6 text-center">
    ...
    <section class="py-12 md:py-16 bg-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-8">
                <h2 class="text-2xl md:text-3xl font-bold text-gray-800">Produk Berdasarkan Kategori {{ $Category->name }}</h2>
                ...
                <div class="bg-white rounded-lg shadow hover:shadow-xl transition overflow-hidden group">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('product.detail',$product->slug) }}" class="bg-blue-600 text-white p-2 rounded-lg hover:bg-blue-700 transition">
